...
public class Base {
    ...
    public static void calculation(int a, int b, int c){
        ...
        int q = addition(a,b);
        System.out.println("a + b + c = "+addition(q,c));
        int w = multiplication(a,a);
        System.out.println("a^3 = "+multiplication(w,a));
        int s = addition(b,multiplication(c,c));
        System.out.println("a - (b + c^2) = "+subtraction(a,s));
    }
